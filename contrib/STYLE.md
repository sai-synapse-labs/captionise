...
- [Table of Contents](#table-of-contents)
  ...
  - [The six rules of a great commit.](#the-six-rules-of-a-great-commit)
      - [1. Atomic Commits](#1-atomic-commits)
      - [Avoid trivial commit messages](#avoid-trivial-commit-messages)
      ...
      - [Tools worth mentioning](#tools-worth-mentioning)
        - [Using `--fixup`](#using---fixup)
        - [Interactive Rebase](#interactive-rebase)
      - [Pull Request and Squashing Commits Caveats](#pull-request-and-squashing-commits-caveats)
